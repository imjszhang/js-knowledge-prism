...
> 第 N 天 · 基于视角 [P23](../../pyramid/structure/{{perspective_dir}}/) · 骨架见 [KLnn](../../pyramid/structure/{{perspective_dir}}/tree/KLnn-xxx.md)
...
**相关 Groups**：[Gxx](../../pyramid/analysis/groups/Gxx-slug.md) · ...
```
